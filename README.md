...
- Maps P22's staged ground modules, Smith forms, resultants, determinantal
  ...
  `x₁`-degree is strictly less than `k`. The characteristic-zero finite-avoidance
  step used after Satz VII is formalized for any supplied finite family of
  regularity coefficients. Construction of the regularity determinants,
  staged resultants, and compatible-zero system remains open.
...
modify the release-verifier-bound source checker.

The current 29-target graph check (27 promoted theorem modules and both
umbrellas) is checkpoint
[`20260826T0014097083391-9fccc982`](artifacts/build/module-graph-checkpoint-20260826T0014097083391-9fccc982.json).
It reuses the 26 theorem modules from the preceding checkpoint, adds P22's
regular-division module, and rebuilds both umbrellas; every current
...
1,838,075,904 bytes under the 4.5 GiB overall envelope; every new build used a
...
- `docs/noether/hentzelt-polynomial-ideals-resultants-1923.md`: the full
  ...
  equation-(21) bounded regular-division representatives, and promoted Satz
  VIII support.
