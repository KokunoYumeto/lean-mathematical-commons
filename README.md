...
- Maps P22's staged ground modules, Smith forms, resultants, determinantal
  ...
  the relative quotient unchanged. This is explicitly classified as
  `NEW_PACKAGING` of Mathlib's second isomorphism theorem, not new mathematics.
...
The current 34-target graph check (32 promoted theorem/support modules and both
umbrellas) is checkpoint
[`20260827T2158428474453-64f62f7d`](artifacts/build/module-graph-checkpoint-20260827T2158428474453-64f62f7d.json).
It reuses 31 unchanged theorem modules, adds P22's source-facing common-tail
quotient equivalence and representative theorem, and rebuilds both umbrellas;
...
[10.5281/zenodo.22133696](https://doi.org/10.5281/zenodo.22133696).
