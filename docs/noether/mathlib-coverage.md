...
Bearbeitung. Its 29 claim/definition records are mapped in
...
| generic transforms and ground ideals, Definitions IV--V and Satz VI | polynomial substitution, homogeneous-degree APIs, localization, relative coefficient modules | equation (12), its natural algebraically-independent lower-pair parameters, homogeneous-degree preservation, the controlling first-variable coefficient and its generator computations, equation (17), literal late-variable stage submonoids, simultaneous denominator presentation, coefficient reconstruction, and the final transformed-contraction equality are promoted. Arbitrary-input generic nonvanishing and ideal-level regular-element construction remain `GAP_CANDIDATE` |
| finite module reduction, Satz VII | finite-free and Smith-normal-form APIs; monic polynomial division; submodule sums and disjointness; polynomial function extensionality and finite products | equations (21)--(23) are promoted for a supplied regular divisor: exact bounded representatives, finite coefficient vectors, the bounded-part/principal-tail decomposition of a containing ideal, and zero intersection of the two parts. The characteristic-zero simultaneous specialization preserving a supplied finite family of regular leading coefficients is also promoted; construction of the source's regular elements, the multistage finite quotient, determinant data, nonunit elementary-divisor theorem, and auxiliary-choice independence remain `GAP_CANDIDATE` |
